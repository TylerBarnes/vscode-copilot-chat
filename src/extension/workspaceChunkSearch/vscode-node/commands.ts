...
export const buildLocalIndexCommandId = 'acp.copilot.buildLocalWorkspaceIndex';
export const buildRemoteIndexCommandId = 'acp.copilot.buildRemoteWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('acp.copilot.debug.collectWorkspaceIndexDiagnostics', async () => {
