...
const ShowCodexPlaceholderKey = 'acp.copilot.chat.codex.showPlaceholder';
...
export class PlaceholderViewContribution extends Disposable {
	constructor(
		...
		this._register(vscode.commands.registerCommand('acp.copilot.chat.installAgent', this.installAgentCommand, this));
	}
