...
export class WalkthroughCommandContribution extends Disposable {
	constructor() {
		super();
        this._register(vscode.commands.registerCommand('acp.copilot.open.walkthrough', () => {
            vscode.commands.executeCommand('workbench.action.openWalkthrough', { category: 'TylerBarnes.copilot-chat-acp#copilotWelcome' }, /* toSide */ false);
        }));

		this._register(vscode.commands.registerCommand('acp.copilot.mcp.viewContext7', () => {
