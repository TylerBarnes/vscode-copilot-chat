...
const NOTEBOOK_FOLLOW_IN_SESSION_KEY = 'acp.copilot.notebookFollowInSessionEnabled';
...
export class NotebookFollowCommands extends Disposable {
	...
	constructor(
		...
		this._register(vscode.commands.registerCommand('acp.copilot.chat.notebook.enableFollowCellExecution', () => {
			this.updateFollowContext(true);
		}));

		this._register(vscode.commands.registerCommand('acp.copilot.chat.notebook.disableFollowCellExecution', () => {
