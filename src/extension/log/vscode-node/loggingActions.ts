...
export class LoggingActionsContrib {
	constructor(
		...
		this._context.subscriptions.push(vscode.commands.registerCommand('acp.copilot.debug.collectDiagnostics', async () => {
...
\`\`\`json${getNonDefaultSettings()}
  "acp.copilot.advanced.debug.useElectronFetcher": ${electronConfig},
  "acp.copilot.advanced.debug.useNodeFetcher": ${nodeConfig},
  "acp.copilot.advanced.debug.useNodeFetchFetcher": ${nodeFetchConfig}
